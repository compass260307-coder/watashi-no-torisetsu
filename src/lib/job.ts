...
export const JOB_INTEGRATION: Record<JobId, string> = {
  sales:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「営業」——自分のペースで過ごしているつもりが、外からは場を温めて人を巻き込む力に見えている。その自覚とのズレこそ、あなたの魅力です。",
  writer:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「作家」——静かに過ごす時間が、外からは内側に深い世界を耕す力に見えている。その自覚とのズレこそ、あなたの魅力です。",
  nurse:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「看護師」——何気ない気づかいが、外からは人の小さな変化を見逃さない優しさに見えている。その自覚とのズレこそ、あなたの魅力です。",
  revolutionary:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「革命家」——素直に感じた違和感が、外からは流れに飲まれずに言い切る強さに見えている。その自覚とのズレこそ、あなたの魅力です。",
  reporter:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「記者」——内向きの好奇心が、外からは聞き出して広める力に見えている。その自覚とのズレこそ、あなたの魅力です。",
  mechanic:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「整備士」——目立たない丁寧さが、外からは任せれば確実という安心感に見えている。その自覚とのズレこそ、あなたの魅力です。",
  secretary:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「秘書」——自然にしている段取りが、外からは周りの予定まで整える気くばりに見えている。その自覚とのズレこそ、あなたの魅力です。",
  traveler:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「旅人」——その時々の気分で選ぶ身軽さが、外からは流れに乗っていく軽やかさに見えている。その自覚とのズレこそ、あなたの魅力です。",
  poet: "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「詩人」——心の揺れやすさが、外からは機微を感じ取る豊かさに見えている。その自覚とのズレこそ、あなたの魅力です。",
  captain:
    "自分では「{animal}」だと思っていたあなた。でも友達から見たあなたは「船長」——いつも通りの落ち着きが、外からは何があっても動じない頼もしさに見えている。その自覚とのズレこそ、あなたの魅力です。",
};
