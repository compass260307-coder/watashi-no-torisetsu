...
export const torisetsuTypes: Record<TorisetsuTypeId, TorisetsuType> = {
  "festival-sun": {
    ...
    shortName: "お祭り系",
    emoji: "🎪",
    imageUrl: "/types/festival-sun.webp",
    color: "#FF4081",
  ...
  "everyones-home": {
    ...
    shortName: "実家系",
    emoji: "🏠",
    imageUrl: "/types/everyones-home.webp",
    color: "#2EC4B6",
  ...
  "wild-charisma": {
    ...
    shortName: "カリスマ系",
    emoji: "🌪️",
    imageUrl: "/types/wild-charisma.webp",
    color: "#FFB800",
  ...
  "iron-mental": {
    ...
    shortName: "鉄壁系",
    emoji: "🛡️",
    imageUrl: "/types/iron-mental.webp",
    color: "#6C5CE7",
  ...
  "delicate-creator": {
    ...
    shortName: "繊細系",
    emoji: "🎨",
    imageUrl: "/types/delicate-creator.webp",
    color: "#00D4AA",
  ...
  "healing-guardian": {
    ...
    shortName: "癒し系",
    emoji: "🌿",
    imageUrl: "/types/healing-guardian.webp",
    color: "#00B894",
  ...
  "deep-dive-explorer": {
    ...
    shortName: "沼系",
    emoji: "🔍",
    imageUrl: "/types/deep-dive-explorer.webp",
    color: "#C44569",
  ...
  "cool-maverick": {
    ...
    shortName: "冷静系",
    emoji: "🧊",
    imageUrl: "/types/cool-maverick.webp",
    color: "#1E90FF",
