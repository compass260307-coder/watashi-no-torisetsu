...
function factorArticle(input: FactorInput): IdArticle {
  return {
    ...
    sections: [
      ...
      { heading: "Kesalahpahaman yang umum", paragraphs: [input.misconception, input.misconceptionFollowup] },
...
export const ID_ARTICLES: IdArticle[] = [
  {
    ...
    sections: [
      ...
      { heading: "Berbeda dari tes 16 tipe", paragraphs: ["Tes 16 tipe menggabungkan pilihan biner menjadi kategori yang mudah diingat. OCEAN mempertahankan skor berkelanjutan agar nuansa di dekat titik tengah tidak hilang.", "Alice Personalities mengukur lima dimensi OCEAN lalu merangkum polanya menjadi satu dari 32 karakter.", "Dengan demikian, ketelitian landasan ilmiah dan keseruan membandingkan hasil bersama teman dapat dinikmati sekaligus."] },
      { heading: "Seberapa andal hasil OCEAN?", paragraphs: ["Struktur lima faktor telah diteliti selama puluhan tahun dalam banyak bahasa dan budaya. Namun, laporan diri tetap dipengaruhi suasana, konteks, dan pemahaman pertanyaan, sehingga hasil sebaiknya dipakai sebagai peta saat ini, bukan vonis permanen.", "Setiap tes penilaian diri memiliki satu batas yang sama: hasilnya terutama mencerminkan diri yang sudah Anda kenali. Sisi yang belum Anda sadari memerlukan sudut pandang lain."] },
      { heading: "Teman dapat melihat sisi yang luput dari diri sendiri", paragraphs: ["Orang lain mengamati perilaku Anda dari sudut berbeda. Kebiasaan yang terasa biasa bagi Anda mungkin justru menjadi kualitas yang paling mereka andalkan.", "Perbedaan antara penilaian diri dan teman bukan selalu kesalahan; perbedaan itu dapat menunjukkan jarak antara niat, perilaku, dan dampak.", "Mulailah dengan mengenali lima dimensi Anda. Tes gratis ini berisi 50 pertanyaan, selesai dalam sekitar tiga menit tanpa pendaftaran, dan menunjukkan karakter mana dari 32 tipe yang paling mendekati Anda."] },
    ],
  },
  {
  ...
  factorArticle({ slug: "shinkeisho-keiko", letter: "N", factor: "Neurotisisme", question: "bagaimana kepekaan menjadi kekuatan", description: "Pelajari kepekaan emosional dan kestabilan serta cara memakai sinyal emosi tanpa kewalahan.", image: "/characters/v3/rabbit_N.webp", imageAlt: "Karakter kelinci yang mewakili kepekaan emosional", high: [{ term: "Peringatan dini", body: "Anda mungkin melihat risiko sebelum orang lain." }, { term: "Nuansa emosi", body: "Perubahan kecil pada nada membawa informasi." }, { term: "Persiapan", body: "Antisipasi mendorong rencana cadangan." }], low: [{ term: "Ketenangan", body: "Stres lebih jarang mengambil alih perhatian." }, { term: "Pemulihan", body: "Kegagalan meninggalkan jejak emosi yang lebih ringan." }, { term: "Toleransi ketidakpastian", body: "Anda tetap bergerak tanpa menyelesaikan semua risiko." }], misconception: "Skor tinggi bukan kelemahan; kepekaan mendukung empati dan pandangan ke depan. Skor rendah bukan ketidakpedulian.", misconceptionFollowup: "Menyadari bahwa Anda peka adalah perlindungan yang penting. Kegelisahan tanpa nama menjadi lebih ringan ketika dapat dikenali sebagai sensor batin yang sedang bereaksi.", practice: "Perlakukan kepekaan sebagai sinyal, bukan perintah: beri nama perasaan, periksa bukti, lalu pilih satu langkah berikutnya." }),
  {
    ...
    sections: [
      ...
      { heading: "Langkah 1: mulai dari pola, bukan ideal", paragraphs: ["Tinjau momen yang terasa mudah, sulit, memberi energi, atau menguras tenaga. Catat yang benar-benar terjadi dan cari pengulangan.", "Cara ini memiliki satu batas: karena Anda menulisnya sendiri, isinya hanya dapat mencakup bagian diri yang sudah Anda kenali."] },
      { heading: "Langkah 2: tambahkan sudut pandang orang lain", paragraphs: ["Tanyakan kepada orang tepercaya apa yang mereka andalkan dari Anda dan apa yang sulit dibaca saat Anda stres. Perbedaan adalah informasi, bukan vonis.", "Di Alice Personalities, tes gratis 50 pertanyaan yang selesai dalam sekitar tiga menit otomatis membuat draf panduan diri sebagai satu dari 32 karakter."] },
      { heading: "Jaga agar panduan dapat diperbarui", paragraphs: ["Tambahkan tanggal dan contoh, lalu tinjau kembali setelah perubahan peran atau lingkungan. Tulis kecenderungan, kondisi, atau hipotesis—bukan batas permanen.", "Dengan membagikan tautan undangan, teman dapat menjawab secara anonim. Perbedaan dari penilaian diri ditambahkan sebagai sisi yang belum Anda kenali, sehingga panduan ini tidak mungkin dibuat hanya dari sudut pandang sendiri."] },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Mengapa area buta penting", paragraphs: ["Kekuatan yang terasa biasa mudah luput. Umpan balik spesifik mengubah dampak yang tidak terlihat menjadi sesuatu yang dapat dipahami dan dipilih.", "Mungkin Anda merasa hanya bersikap biasa, sementara orang lain menganggap Anda selalu tenang; atau perhatian yang tidak pernah Anda sadari ternyata benar-benar dilihat teman. Membuka area buta sering menghadirkan penemuan yang sedikit memalukan tetapi menyenangkan."] },
      { heading: "Cara meminta umpan balik dengan aman", paragraphs: ["Ajukan pertanyaan sempit tentang konteks nyata, minta contoh, dan dengarkan sebelum memutuskan apa yang sesuai.", "Penilaian anonim membantu karena pertanyaannya sudah tersedia dan teman dapat menjawab dengan jujur tanpa mencantumkan nama pada setiap pengamatan."] },
      { heading: "Umpan balik adalah jendela, bukan putusan", paragraphs: ["Satu orang melihat dari satu posisi. Gabungkan beberapa sudut pandang dengan pengalaman Anda sendiri.", "Selisih antara penilaian diri dan penilaian teman menjadi halaman paling menarik dalam panduan Anda: area buta atau sisi diri yang belum Anda kenali. Maukah Anda melihatnya?"] },
    ],
  },
  {
    ...
    sections: [
      { heading: "Kemiripan memudahkan kehidupan sehari-hari", paragraphs: ["Kecenderungan serupa menciptakan asumsi bersama, tetapi juga dapat memperkuat titik buta yang sama.", "Ada pula kecocokan yang lahir karena perbedaan saling mengisi: orang terencana dengan orang yang cepat bertindak, atau pendengar yang baik dengan pembicara yang ekspresif. Pasangan yang berbeda dapat melakukan hal yang sulit dilakukan sendirian."] },
      { heading: "Perbedaan menciptakan keseimbangan atau gesekan", paragraphs: ["Sifat berbeda dapat saling melengkapi. Gesekan muncul ketika preferensi pribadi dianggap satu-satunya cara yang masuk akal.", "Mengetahui letak perbedaan membuat hubungan jauh lebih ringan. Perbedaan bukan bukti kecocokan buruk, melainkan variasi cara yang dapat menjadi bahan tawa jika dipahami lebih dulu."] },
      { heading: "Gunakan kecocokan sebagai awal percakapan", paragraphs: ["Bandingkan dimensi tertentu dan bicarakan contoh sehari-hari. Pembacaan yang baik memberi pilihan praktis, bukan alasan untuk tidak menghormati orang lain.", "Jika hubungan itu penting bagi Anda, hasil kecocokan dapat menjadi alasan yang alami untuk memulai percakapan dan memperkecil jarak."] },
      { heading: "Yang penting di luar kepribadian", paragraphs: ["Nilai, keadaan, keterampilan komunikasi, kekuasaan, waktu, dan kesediaan memperbaiki hubungan ikut menentukan kualitas hubungan.", "Jika Anda belum mengetahui tipe sendiri, mulailah dari tes gratis 50 pertanyaan yang selesai dalam sekitar tiga menit. Hasilnya dapat langsung digunakan dalam fitur kecocokan."] },
    ],
  },
  {
    ...
    sections: [
      { heading: "Mengapa analisis diri saja terbatas", paragraphs: ["Kebiasaan yang akrab menjadi tak terlihat. Orang lain tidak melihat seluruh batin Anda, tetapi dapat melaporkan dampak pada momen yang mungkin Anda lupakan.", "Keduanya sama-sama bertujuan mengenali diri, tetapi jenis informasi yang terkumpul benar-benar berbeda."], list: [{ term: "Analisis diri", body: "Menunjukkan niat, pengalaman pribadi, nilai, dan alasan." }, { term: "Sudut pandang luar", body: "Menunjukkan perilaku, dampak, dan pola yang dapat diamati." }] },
      { heading: "Apa yang dapat diungkapkan orang lain", paragraphs: ["Umpan balik berguna untuk pola yang dapat diamati: cara masuk ke kelompok, merespons tekanan, berbeda pendapat, atau membantu orang lain.", "Anda mungkin merasa bersikap biasa, tetapi teman melihat ketenangan atau perhatian yang tidak pernah Anda sadari. Umpan balik sering memberi nama pada kekuatan yang mungkin tidak akan ditemukan lewat analisis diri saja."] },
      ...
      { heading: "Pertanyaan anonim dan berbasis pilihan mengurangi kecanggungan", paragraphs: ["Orang lebih jujur ketika tidak dipaksa menulis kritik atau menempelkan nama pada setiap pengamatan.", "Format anonim dan berbasis pilihan membuat teman tidak perlu bingung harus menulis apa. Kemudahan menjawab sangat menentukan banyaknya pengamatan jujur yang dapat terkumpul."] },
      { heading: "Coba fitur teman di Alice Personalities", paragraphs: ["Selesaikan tes OCEAN Anda, bagikan tautan undangan, lalu bandingkan pandangan diri dengan pola jawaban teman. Gunakan hasil sebagai awal percakapan.", "Selisih antara penilaian diri dan teman menjadi area buta sekaligus halaman paling menarik dalam panduan Anda. Mulailah dari tes gratis 50 pertanyaan selama sekitar tiga menit, lalu mintalah teman menunjukkan sisi diri yang belum Anda kenali."] },
    ],
  },
];
