...
export const EN_ARTICLES: EnArticle[] = [
  {
    ...
    imageAlt: "Alice Personalities characters taking a personality test",
    lead: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Alice Personalities measures the five OCEAN dimensions, then turns the pattern into one of 32 characters. The scores preserve nuance while the character makes the result easier to remember and use.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "That is why Alice Personalities combines your own answers with optional friend feedback: not to decide who is right, but to make the picture wider.",
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "You can combine accuracy with enjoyment", paragraphs: ["Alice Personalities begins with OCEAN scores and uses a 32-character system to make the pattern approachable. The character summarizes the result; it does not replace the five scores beneath it.", "Use the character to start a conversation, then return to the dimensions when you want a more precise explanation of a strength, tension, or relationship."] },
    ],
  },
  factorArticle({
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Try friend feedback in Alice Personalities", paragraphs: ["Complete your own OCEAN test, share your invitation link, and compare your self-view with the patterns in your friends’ answers.", "Use the result as the beginning of a conversation. A good insight should make understanding easier, not make anyone feel reduced to a label." ] },
    ],
  },
];
