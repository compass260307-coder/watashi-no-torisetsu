...
> = {
  self_report: {
    ...
    name: { ja: "学生向けプラン", ko: "학생 플랜", en: "Unavailable English plan", id: "Paket tidak tersedia" },
  },
  full_access: {
    fallbackId: "full_access_jpy_499_restored_v43",
    koFallbackId: "full_access_krw_2900",
  ...
  premium_bundle: {
    ...
    name: { ja: "全部入り・買い切り", ko: "프리미엄 코스", en: "Unavailable English plan", id: "Paket tidak tersedia" },
  },
  unmei: {
    fallbackId: "unmei_jpy_1980",
    name: { ja: "運命の設計図", ko: "운명의 설계도", en: "Destiny Blueprint", id: "Peta Takdir" },
  },
  unmei_upgrade: {
