...
// =====================================================================
// 「あなたに沼る人」(2026-07-24 追加。/tako ②恋愛の課金ブロック刷新)。
...
> = {
  E: {
    high: {
      title: "太陽感に沼る",
      body: "毎日ちょっと疲れてる人ほど、あなたの明るさに救われて落ちる。「この人といると元気出る」は、恋の入り口として最強だよ。",
    },
    low: {
      title: "静かな聞き上手に沼る",
      body: "話を最後まで聞いてもらえた経験が少ない人ほど、あなたの前で初めて素になれて、そのまま落ちる。",
    },
  },
  A: {
    high: {
      title: "さりげない気づかいに沼る",
      body: "頑張り屋で人に甘えられない人ほど、あなたの「気づいてくれる」にやられる。本人が無意識なのが、またずるい。",
    },
    low: {
      title: "ブレない自分軸に沼る",
      body: "周りに合わせて疲れてる人ほど、流されないあなたの芯に憧れて、気づけば目で追ってる。",
    },
  },
  O: {
    high: {
      title: "世界が広がる感じに沼る",
      body: "毎日が同じで退屈してる人ほど、あなたの「ここ行ってみない？」で世界が変わって、抜け出せなくなる。",
    },
    low: {
      title: "変わらない安心感に沼る",
      body: "刺激的な恋に疲れた人ほど、あなたとの「いつも通り」が心地よくて、帰ってこれなくなる。",
    },
  },
  C: {
    high: {
      title: "有言実行に沼る",
      body: "口だけの人にがっかりしてきた人ほど、黙って約束を守るあなたに「この人は違う」と落ちる。",
    },
    low: {
      title: "マイペースの自由さに沼る",
      body: "きっちりしすぎる毎日に窮屈さを感じてる人ほど、あなたのゆるさでやっと呼吸できて、離れられなくなる。",
    },
  },
  N: {
    high: {
      title: "感情の深さに沼る",
      body: "浅い会話に飽きてる人ほど、あなたの繊細な感受性に触れて「わかってもらえた」と感じて落ちる。",
    },
    low: {
      title: "動じない包容力に沼る",
      body: "不安になりやすい人ほど、何があっても慌てないあなたの隣が、世界でいちばん安全な場所になる。",
    },
  },
};
...
> = {
  E: {
    ...
    low: "騒がしい飲み会のあとで、あなただけが自分の話を覚えていてくれたと気づいた瞬間。",
  },
  A: {
    high: "疲れてる日に「大丈夫？」の言葉より先に、温かい飲み物がすっと出てきた瞬間。",
    low: "みんなが空気を読んで黙る場面で、あなただけが「私はこう思う」と言った瞬間。",
  },
  O: {
...
/** 友達の回答から「あなたに沼る人」を決定的に生成する。2軸未満なら null。 */
...
const LOSS_BY_AXIS: Record<BigFiveDimension, LossItem> = {
  ...
  N: {
    ...
    hint: "悩んだ文面は、そのまま送っていい日のほうが多いよ。あなたの繊細さは重さじゃなくて深さだから。",
  },
};
