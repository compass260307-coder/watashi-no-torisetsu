...
export const thirtyTwoCharacter: Record<ThirtyTwoTypeId, ThirtyTwoCharacter> = {
  ...
  "quiet-owl__N": { name: "きらめきインコ", animal: "インコ", essence: "太陽の社交家", oneLiner: "明るい好奇心で人の輪を彩る、みんなの気持ちに敏感な社交家。", slug: "parakeet_N", group: "sky" },
  "quiet-owl__R": { name: "どうどうワシ", animal: "ワシ", essence: "不動の王者", oneLiner: "何があっても揺るがない、堂々と前を照らす不動のリーダー。", slug: "eagle_R", group: "sky" },
  "seeker-wolf__N": { name: "すいすいツバメ", animal: "ツバメ", essence: "身軽な先駆者", oneLiner: "身軽に新しい世界へ飛び込む、感受性ゆたかな先駆者。", slug: "swallow_N", group: "sky" },
  "seeker-wolf__R": { name: "クールタカ", animal: "タカ", essence: "孤高の狩人", oneLiner: "一人静かに狙いを定める、冷静で揺るがない孤高の狩人。", slug: "hawk_R", group: "sky" },
  "dreamer-rabbit__N": { name: "なかよしペンギン", animal: "ペンギン", essence: "甘えん坊の人気者", oneLiner: "人懐っこくて甘え上手、みんなに愛される心やさしい人気者。", slug: "penguin_N", group: "sky" },
  "dreamer-rabbit__R": { name: "ゆうがハクチョウ", animal: "ハクチョウ", essence: "優雅な大物", oneLiner: "落ち着いた佇まいで場を包む、動じない優雅な大物。", slug: "swan_R", group: "sky" },
  "fantasy-cat__N": { name: "きまぐれカラス", animal: "カラス", essence: "自由な観察者", oneLiner: "自由気ままに世界を眺める、独自の感性を持つ観察者。", slug: "crow_N", group: "sky" },
  ...
  "earnest-elephant__N": { name: "じゅんすいユニコーン", animal: "ユニコーン", essence: "純粋な理想家", oneLiner: "まっすぐな理想を胸に抱く、純粋でやさしい夢追い人。", slug: "unicorn_N", group: "unknown" },
  "earnest-elephant__R": { name: "ゆるぎないドラゴン", animal: "ドラゴン", essence: "不動の守護者", oneLiner: "何があっても揺らがない、静かな威厳を持つ守護者。", slug: "dragon_R", group: "unknown" },
  "steady-turtle__N": { name: "あこがれペガサス", animal: "ペガサス", essence: "高みを目指す夢追い", oneLiner: "高い理想へ静かに羽ばたく、感受性ゆたかな夢追い。", slug: "pegasus_N", group: "unknown" },
  "steady-turtle__R": { name: "ふくつのフェニックス", animal: "フェニックス", essence: "不屈の再生者", oneLiner: "何度でも立ち上がる、折れない不屈の再生者。", slug: "phoenix_R", group: "unknown" },
  "gentle-koala__N": { name: "おもいやりエンジェル", animal: "エンジェル", essence: "慈愛の使い", oneLiner: "誰かの幸せをそっと願う、慈愛にあふれた癒し手。", slug: "angel_N", group: "unknown" },
  "gentle-koala__R": { name: "ふどうゴーレム", animal: "ゴーレム", essence: "不動の番人", oneLiner: "どっしり構えて動じない、静かに守り抜く不動の番人。", slug: "golem_R", group: "unknown" },
  "solo-hedgehog__N": { name: "てれやオバケ", animal: "オバケ", essence: "はにかみ屋", oneLiner: "自分の世界をそっと守る、はにかみ屋の独立心。", slug: "ghost_N", group: "unknown" },
  "solo-hedgehog__R": { name: "のんきガイコツ", animal: "ガイコツ", essence: "飄々の自由人", oneLiner: "何にも縛られず飄々と生きる、マイペースな自由人。", slug: "skeleton_R", group: "unknown" },
};
