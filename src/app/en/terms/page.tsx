...
export default function EnglishTermsPage() {
  return (
    <EnLegalDocument title="Terms of Service" lastUpdated="September 10, 2026">
      <p>
        These Terms of Service (“Terms”) govern the English version of Alice Personalities (“Service”), provided by Ryunosuke Futami / the Alice Personalities Operations Team (“Operator”). By using the Service, you agree to these Terms.
      </p>
      ...
      <h2>14. Contact</h2>
      <ul>
        <li>Operator: Ryunosuke Futami (Alice Personalities Operations Team)</li>
