...
export const metadata: Metadata = {
  ...
  description: "How the English version of Alice Diagnosis handles personal information.",
...
export default function EnglishPrivacyPage() {
  return (
    <EnLegalDocument title="Privacy Policy" lastUpdated="September 10, 2026">
      <p>
        Ryunosuke Futami / the Alice Diagnosis Operations Team (“Operator”) handles personal information used in the English version of Alice Diagnosis (“Service”) as described below.
      </p>

      <h2>1. Data controller and contact</h2>
      <ul>
        <li>Controller: Ryunosuke Futami (Alice Diagnosis Operations Team)</li>
