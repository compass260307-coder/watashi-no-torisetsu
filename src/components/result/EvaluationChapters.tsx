...
//
// ★ Day 12 コンテンツ再設計 (7→4セクション) で /evaluate/result からの参照を撤去。
//   現在このコンポーネントはどのページからも使われていないが、Stripe コードと同様、
//   後日の「有料深掘りレポート」で再利用するため意図的に温存している (削除しないこと)。
//   - 旧③強み6/旧④あれっ?6 → 新③ (PerceptionFoundYou) が各3つに絞って表示中。残り3つはここ経由で復元可
//   - 旧⑤4つの特性 / 旧⑥関係性アドバイス / 旧⑦取説B視点 → 本文データは lib/mutual-result-content.ts
//
// 章構成 (Day 12 指示書):
