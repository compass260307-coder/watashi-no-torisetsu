...
export const ME_UNMEI_CHAT_INTRO_KO: readonly string[] = [
  "처음 뵙겠어요. 당신만을 위한 점성술사 Alice예요. 지금까지의 진단 결과는 이미 읽어 봤어요.",
  "이제 태어난 날짜·시간·장소, 세 가지만 알려 주면 출생 차트와 진단 결과를 함께 읽은 ‘나의 운명 설계도’를 완성할 수 있어요.",
...
export const ME_UNMEI_CHAT_INTRO_EN: readonly string[] = [
  ...
  "Tell me your date, time, and place of birth, and I can combine your birth chart with your personality profile to complete your Destiny Blueprint.",
  "Let’s begin with the day you came into the world.",
];

export const ME_UNMEI_CHAT_INTRO_ID: readonly string[] = [
  "Hai, aku Alice, astrolog pribadimu. Aku sudah membaca hasil kepribadianmu.",
  "Beri tahu tanggal, waktu, dan tempat lahirmu. Aku akan menggabungkan peta kelahiran dengan profil kepribadianmu untuk menyelesaikan Peta Takdir.",
  "Mari mulai dari hari ketika kamu lahir ke dunia.",
];
...
export const UNMEI_CHAT_COPY: Record<AppResultLocale, ChatCopy> = {
  ...
  en: {
    ...
    askPlace: "Finally, where were you born? This helps me recreate the sky at the moment you were born. You can skip this if you’re unsure.",
    ...
    regionAria: "Birth state or territory",
    regionPlaceholder: "Select a state or territory",
  ...
  id: {
    guideName: "Alice",
    productName: "Astrolog pribadimu",
    srTitle: "Data kelahiran untuk Peta Takdirmu",
    introInput: [
      "Terima kasih atas pembelianmu!",
      "Aku akan menggabungkan langit saat kamu lahir dengan kepribadianmu untuk membuat Peta Takdir khusus untukmu.",
      "Pertama, beri tahu hari ketika kamu lahir ke dunia.",
    ],
    introPurchase: [
    ...
    futureDate: "Tanggal itu berada di masa depan. Pilih kembali tanggal lahirmu.",
    thanks: "Terima kasih.",
    askTime: [
      "Selanjutnya, pukul berapa kamu lahir?",
      "Waktu lahir membantuku membaca posisi bintang dengan lebih tepat. Kamu bisa memeriksa catatan kelahiran, tetapi tidak apa-apa jika tidak tahu.",
    ],
    unknownTimeAnswer: "Saya tidak tahu waktu lahir saya",
    askPlace: "Terakhir, di mana kamu lahir? Ini membantuku menciptakan kembali langit saat kamu lahir. Kamu boleh melewatinya jika tidak yakin.",
    unknownTimeReply: "Tidak apa-apa. Aku akan memakai langit pada tengah hari sebagai acuan.",
    skipAnswer: "Lewati",
    skipReply: "Tidak apa-apa. Aku akan membuat pembacaan dengan teliti dari informasi yang ada.",
    editQuestions: {
      date: "Beri tahu tanggal lahirmu sekali lagi.",
      time: "Beri tahu waktu lahirmu sekali lagi.",
      place: "Beri tahu tempat lahirmu sekali lagi.",
    },
    confirmLead: "Tiga kunci yang kubutuhkan untuk petamu sudah lengkap.",
    dateField: "Tanggal lahir",
    timeField: "Waktu lahir",
    placeField: "Tempat lahir",
    unknownTimeLabel: "Tidak diketahui (dihitung pada tengah hari)",
    unknownPlaceLabel: "Tidak diisi",
    previewConfirmed: "Terima kasih. Datamu sudah kuperiksa.",
    previewPayment: "Pada alur sebenarnya, data kelahiranmu disimpan di sini sebelum konfirmasi pembelian terakhir.",
    saveError: "Datamu tidak dapat disimpan. Coba lagi.",
    preparing: [
      "Menciptakan kembali langit saat kamu lahir…",
      "Menumpuk susunan bintang di atas kepribadianmu…",
      "Mengubah kisahmu menjadi peta yang hanya dibuat untukmu…",
    ],
    paymentReady: "Semua sudah siap untuk Peta Takdirmu",
    paymentNext: "Selesaikan pembelian di bawah dan aku akan segera mulai membaca bintangmu.",
    generationReady: "Aku sudah menerima tiga kuncimu. Sekarang aku akan membuat peta pribadimu.",
    networkError: "Terjadi kesalahan jaringan. Coba lagi.",
    typing: "Membaca bintang",
    waiting: "Aku sedang menggabungkan langit saat kamu lahir dengan kepribadianmu. Proses ini mungkin memerlukan sekitar satu menit.",
    year: "Tahun",
    month: "Bulan",
    day: "Hari",
    yearSuffix: "",
    monthSuffix: "",
    daySuffix: "",
    birthTimeAria: "Waktu lahir",
    unknownTimeChip: "Saya tidak tahu waktu lahir saya",
    regionAria: "Provinsi kelahiran",
    regionPlaceholder: "Pilih provinsi",
    cityPlaceholder: "Kota/kabupaten (opsional)",
    skipChip: "Lewati",
    editDate: "Ubah tanggal",
    editTime: "Ubah waktu",
    editPlace: "Ubah tempat",
    submitting: "Menyimpan datamu…",
    purchaseContinue: "Lanjutkan dengan data ini",
    confirm: "Buat petaku",
    send: "Kirim",
    formatDate: (year, month, day) =>
...
export const UNMEI_READING_COPY = {
  ...
  id: {
    ...
    youAre: "Kamu adalah",
    groupSuffix: "",
    fallbackConstellation: "Konstelasi bintangmu",
    ending: [
      "Bintang bukanlah jawaban, melainkan penunjuk jalan.",
      "Saat merasa tersesat, kamu selalu bisa kembali ke langit ini.",
    ],
    sectionTitles: {
...
export const UNMEI_CHART_COPY = {
  ...
  id: {
    label: "Peta kelahiran",
    titleLabel: "Gelar yang diberikan bintang kepadamu",
    moon: "Bulan",
    details: (label: string) => `Lihat detail ${label}`,
    scroll: "Gulir",
    arrangement: "Susunan planet pada saat kamu lahir",
    touchHint: "Pilih bintang untuk mengetahui lebih lanjut",
    timeUnknownNote: "Mengetahui waktu lahir akan memastikan posisi Bulan.",
    phrases: [
      "Inilah langit pada saat kamu lahir.",
      "Susunan yang sama tidak akan pernah kembali.",
      "Kisahmu dimulai dari sini.",
    ],
    meanings: {
      sun: "Pusat kisahmu yang menerangi hal paling penting bagimu",
      moon: "Tempat hatimu kembali ketika kamu sendiri",
      mercury: "Cara kamu memilih kata, berpikir, dan memahami dunia",
      venus: "Hal yang menggerakkan hatimu dan caramu mengekspresikan cinta",
      mars: "Api batin yang mendorongmu mengambil langkah pertama",
      jupiter: "Arah tempat kamu tumbuh dan memperluas kemungkinan secara alami",
      saturn: "Hal yang sungguh menjadi milikmu melalui waktu, kesabaran, dan kedewasaan",
      asc: "Aura yang kamu kenakan saat pertama kali bertemu dunia",
      mc: "Titik tertinggi di langit yang dituju perjalanan panjangmu",
    },
  },
} as const;
