...
export function buildEnSelfSections(
  ...
  return [
    {
      title: "Your Alice Personalities Result",
...
const EN_SCENES: readonly EnSceneRule[] = [
  ...
  },
  {
    ...
    color: "#F48BAE",
    gated: true,
    main: { dim: "E", high: "Your voice comes out first. You alert everyone around you, and before you know it you are walking at the front of the evacuation.", low: "Your mind moves before any commotion does. You confirm where the exits are and quietly signal the people nearby that it is time to go." },
    spice: { dim: "N", high: "Chances are you were also the first one to notice that something about the atmosphere felt off.", low: "Complete with nerves so steady that you later surprise everyone by asking whether that really happened." },
  },
  {
