...
const JA_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "完全版コース（¥499）にはAliceの1回答体験、プレミアムコース（¥899）には30回答分が含まれます。お試しコース（¥199）にはチャット利用分は含まれません。いずれも月額ではなく買い切りです。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "完全版コースで1回答を試した後、差額¥400でプレミアムコースへアップグレードでき、購入分は合計30回答になります。30回答を使い切った後の追加購入は、現在は対応していません。",
    },
    {
  ...
  title: "星読みの案内人と話す",
  heroAlt: "星図を広げた机で案内する、星読みの案内人のフェルトうさぎ",
  description:
...
const KO_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "프리미엄 코스(₩8,900)에는 30회의 채팅이 포함돼요. 라이트 코스(₩1,900)와 완전판 코스(₩4,900)에는 채팅이 포함되지 않아요. 모든 코스는 구독이 아닌 1회 결제예요.",
    },
    {
