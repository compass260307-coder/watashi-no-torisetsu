...
const JA_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "完全版（¥899）で、Aliceとのチャットを30回利用できます。学生向けプラン（¥499）にはチャット利用分は含まれません。月額ではありません。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "学生向けプランから完全版へは差額の¥400でアップグレードできます。過去の完全版で利用枠が30回未満の場合は、全部入りへのアップグレードで合計30回になります。30回を使い切った後の追加購入には、現在対応していません。",
    },
    {
  ...
  title: "Aliceと話す",
  heroAlt: "星柄のマントと白い翼をまとい、机で星のノートを書くAI占い師Alice",
  description:
    "性格診断と星読みでわかるのは、単なるタイプ分けではなく、これからの選択の道しるべです。親しみやすく洞察力のあるAI占い師「Alice」と一緒に、あなたらしい選び方を見つけましょう。",
  exhaustedPlaceholder: "チャット回数を使い切りました",
  inputPlaceholder: "今、何が気になっていますか？",
  startAria: "会話を始める",
  purchaseHint: "相談内容を送信すると、完全版の購入画面を開けます。",
...
const KO_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "완전판 코스(₩4,900)에서 Alice와 30회 채팅할 수 있어요. 학생 플랜(₩1,900)에는 채팅 이용 횟수가 포함되지 않아요. 월정액이 아닌 1회 결제예요.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "학생 플랜에서 완전판으로는 차액 ₩3,000으로 업그레이드할 수 있어요. 과거 완전판의 이용 횟수가 30회 미만인 경우에는 프리미엄 업그레이드로 총 30회를 이용할 수 있어요. 30회를 모두 사용한 뒤의 추가 구매는 현재 지원하지 않아요.",
    },
    {
  ...
  title: "별자리 상담사와 대화하기",
  heroAlt: "별무늬 망토와 흰 날개를 두르고 책상에서 별의 노트를 쓰는 AI 점술사 Alice",
  description:
