...
const JA_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "完全版（¥499）で、Aliceとのチャットを30回利用できます。学生向けプラン（¥299）にはチャット利用分は含まれません。月額ではありません。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "学生向けプランから完全版へは差額の¥200でアップグレードできます。過去の完全版で利用枠が30回未満の場合は、全部入りへのアップグレードで合計30回になります。30回を使い切った後の追加購入には、現在対応していません。",
    },
    {
