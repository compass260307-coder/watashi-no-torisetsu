...
const KO_COPY: HoshiyomiCopy = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "완전판 코스(₩2,900)에서 Alice와 30회 채팅할 수 있어요. 한국어판에서 현재 판매하는 유료 상품은 완전판 하나이며, 월정액이 아닌 1회 결제예요.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "과거 학생 플랜 구매자는 기존 결제 금액을 반영한 차액으로 완전판으로 전환할 수 있어요. 완전판의 30회를 모두 사용한 뒤의 추가 구매는 현재 지원하지 않아요.",
    },
    {
