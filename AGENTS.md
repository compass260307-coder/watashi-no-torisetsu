...
- The Japanese Web `full_access` offer is frozen at a JPY 1,290 reference price and JPY 499 checkout price. Do not change the product, price, billing type, entitlements, trial, promotion, or paywall version without explicit user authorization. Run `npm run verify:commerce`; production builds enforce this contract.
