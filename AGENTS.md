...
- The Japanese Web `full_access` offer is fixed at a JPY 1,290 reference price and JPY 499 checkout price. Run `npm run verify:commerce`; production builds enforce this contract.
